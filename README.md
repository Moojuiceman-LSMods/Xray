...
Adds a keybind to toggle visibility of the currently held item. Useful to see where you're going when carrying large items.
...
Toggle Key - Keybind to toggle held item visibility